...
``compressai/layers/`` proper. Currently hosts the stride / upsample
wrappers around :class:`ResidualBottleneckBlock` originally introduced for
DCAE (Lu et al., CVPR 2025) and reused by SAAF (Ma et al., CVPR 2026).
"""
