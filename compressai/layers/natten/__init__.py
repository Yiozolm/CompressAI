...
A future revision can wire ``natten.functional.na2d_qk{rpb}_with_bias`` /
``na2d_av`` while keeping the same parameter layout, providing a CUDA fast
path without breaking state_dicts.
"""
