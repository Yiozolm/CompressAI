...
DCAE (the two are Family 1 cousins) and reuses
...
class SAAF(CompressionModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # h_z_s2 for *means*; DualHyperSynthesis(h_mean_s, h_scale_s)
        ...
        # TCM / DCAE). channel_context covers y0..y(K-1); each head sees
